let calendar = () => {
    let currentDate, mode = "days", dateString, modeObj;

    return {
        oninit : (vnode)=>{
            currentDate = new Date();

            modeObj = vnode.attrs.ressource ? rdays : days;
            ...
            if(vnode.attrs.mode){
                ...
                if (mode == "days"){
                    ...
                    modeObj = vnode.attrs.ressource ? rmonth : month;
                }
            }
        ...
        view : (vnode)=>{
            ...
            "data-ressource" : vnode.attrs.ressource ? "true" : "false",
            class : 'max-w-4xl'}, [
